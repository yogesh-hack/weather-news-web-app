    ...
    <>
      <div className="container px-10 mt-10 w-[50rem]">
        ...
        <div className="w-max grid gap-10 py-10 grid-cols-1mb-6 lg:grid-cols-2">
           {/*<WeatherCard city={data.name} temp={((data.main.temp) - 273.15).toFixed(2)} desc={data.weather[0].description} icon={data.weather[0].icon} pressure={data.main.pressure} visiblity={data.visibility} humadity={data.main.humidity} /> */}
